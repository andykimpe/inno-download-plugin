...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	downloader.addFile(_T("http://test1.ru/test1.zip"), _T("test1.rar"));
	downloader.addFile(_T("http://test1.ru/test2.zip"), _T("test2.rar"));
	downloader.addFile(_T("http://test1.ru/test3.zip"), _T("test3.rar"));
